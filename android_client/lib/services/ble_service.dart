...
class BleService {
  ...
  final Map<String, String> _discoveredPeers = {}; // deviceId -> deviceName
  ...
  Future<SyncResult> syncWithPeer(BluetoothDevice device) async {
    try {
      ...
      // Subscribe to notifications (incoming records from peer)
